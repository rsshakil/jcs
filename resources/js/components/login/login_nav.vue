                        ...
                        <ul class="navbar-nav border-left flex-row ">
                                <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-small" aria-labelledby="navbarDropdown">
                                            <a class="dropdown-item" href="/language/en"><span class="flag-icon flag-icon-us"></span> English</a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="/language/ja"><span class="flag-icon flag-icon-jp"></span> 日本語</a>
                                        </div>
                                    </li>
                        </ul>
