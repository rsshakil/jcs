<template>
    <div class="row" v-can="['byr_view']">
                <div class="col-12">
                    <h4 class="top_title text-center" style="margin-top:10px;">返品データ</h4>
                </div>
                ...
                <div class="col-12">
                    ...
                    {{ option.company_name }}
                                ...
                                <tr>
                                    ...
                                    <th class="sorting" data-sorting_type="asc" data-column_name="email" style="cursor: pointer">返品データ<span id="ordertype_icon"></span></th>
                                </tr>
                            ...
                            <tbody>
                                <tr v-for="(value,index) in return_lists" :key="value.byr_return_id">
                                    ...
                                    <td><button class="btn btn-primary">返品データ</button></td>
